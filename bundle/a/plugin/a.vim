...
call <SID>AddAlternateExtensionMapping('h',"c,cpp,cxx,cc,CC,ui")
call <SID>AddAlternateExtensionMapping('H',"C,CPP,CXX,CC,UI")
call <SID>AddAlternateExtensionMapping('hpp',"cpp,c")
call <SID>AddAlternateExtensionMapping('HPP',"CPP,C")
call <SID>AddAlternateExtensionMapping('hh',"cpp,c,ui")
call <SID>AddAlternateExtensionMapping('HH',"CPP,C,UI")
call <SID>AddAlternateExtensionMapping('c',"h")
call <SID>AddAlternateExtensionMapping('C',"H")
call <SID>AddAlternateExtensionMapping('cpp',"hh,h,hpp,ui")
call <SID>AddAlternateExtensionMapping('CPP',"HH,H,HPP,ui")
...
call <SID>AddAlternateExtensionMapping('CXX',"H")
call <SID>AddAlternateExtensionMapping('ui',"h,H, hh, HH, cpp, CPP")
call <SID>AddAlternateExtensionMapping('UI',"h,H, hh, HH, cpp, CPP")
" Mappings for PSL7
